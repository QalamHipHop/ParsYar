...
final class Installer
{
    ...
    public static function runMigrations(): void
    {
        ...
        // مهاجرت v1.8.0: جدول device موبایل (React Native FCM/APNs)
        self::migrateMobileDevicesTable();
    ...
    /**
     * مهاجرت جدول device موبایل (v1.8.0).
     * FCM (Android) و APNs (iOS) token ها در این جدول نگهداری می‌شوند.
     */
    private static function migrateMobileDevicesTable(): void
    {
        require_once ABSPATH . 'wp-admin/includes/upgrade.php';
        global $wpdb;
        $charset = $wpdb->get_charset_collate();
